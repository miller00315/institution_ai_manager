# EduTest AI - Institution Application

Aplicação exclusiva para Gestores de Instituições do sistema EduTest AI.
...
Apenas usuários com role `Institution` podem acessar esta aplicação.
